...
class IDLE:
    ...
    def draw(self):
        if self.dir == 1:
            self.image.clip_draw(int(self.frame)*182, 0, 182, 168, self.x, self.y)
        else:
            self.image.clip_composite_draw(int(self.frame)*182, 0, 182, 168,3.141592,'v',self.x, self.y,182, 182)
...
class SLEEP:
    ...
    def draw(self):
        if self.face_dir == -1:
            ...
            self.image.clip_composite_draw(int(self.frame) * 100 * 100, 300, 100, 100,
                                          3.141592 / 2, '', self.x - 25, self.y - 25, 100, 100)
...
class Bird:
    ...
    def __init__(self):
        self.x, self.y = random.randint(100,1700), 150
        self.frame = 0
