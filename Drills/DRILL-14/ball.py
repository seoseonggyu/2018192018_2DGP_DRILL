...
class Ball:
    ...
    def __init__(self):
        ...
        self.x, self.y, self.fall_speed = random.randint(100, 1800), random.randint(100, 1000), 0
    ...
    def update(self):
        ...
        self.x = clamp(0 + 50, self.x, server.background.w - 1 - 50)
        self.y = clamp(0 + 50, self.y, server.background.h - 1 - 50)
